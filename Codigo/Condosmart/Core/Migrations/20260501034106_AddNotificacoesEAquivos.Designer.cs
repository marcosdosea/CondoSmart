...
namespace Core.Migrations.Condosmart
{
    ...
    [Migration("20260501034106_AddNotificacoesEAquivos")]
    partial class AddNotificacoesEAquivos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.AreaDeLazer", b =>
                {
                    ...
                    b.Property<string>("ImagemNomeOriginal")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)")
            ...
            modelBuilder.Entity("Core.Models.ConfiguracaoMensalidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("QuantidadeParcelasPadrao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(12)
                    ...
                    b.HasIndex(new[] { "CondominioId" }, "ux_config_mensalidade_condominio")
                        .IsUnique();

                    b.ToTable("configuracao_mensalidades", (string)null);
                });

            modelBuilder.Entity("Core.Models.Mensalidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "CondominioId" }, "ix_mensalidades_condominio");

                    b.HasIndex(new[] { "MoradorId" }, "ix_mensalidades_morador");

                    b.HasIndex(new[] { "Status" }, "ix_mensalidades_status");

                    b.HasIndex(new[] { "UnidadeId" }, "ix_mensalidades_unidade");

                    b.HasIndex(new[] { "Vencimento" }, "ix_mensalidades_vencimento");

                    b.HasIndex(new[] { "UnidadeId", "CondominioId", "Competencia" }, "uq_mensalidade")
                        .IsUnique();
            ...
            modelBuilder.Entity("Core.Models.NotificacaoSistema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "CondominioId" }, "ix_notificacoes_condominio");

                    b.HasIndex(new[] { "CreatedAt" }, "ix_notificacoes_created_at");

                    b.ToTable("notificacoes_sistema", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Models.ConfiguracaoMensalidade", b =>
                {
                    b.HasOne("Core.Models.Condominio", "Condominio")
                        .WithMany("ConfiguracoesMensalidade")
                        .HasForeignKey("CondominioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Core.Models.Mensalidade", b =>
                {
                    ...
                    b.HasOne("Core.Models.Pagamento", "Pagamento")
                        .WithMany("Mensalidades")
            ...
            modelBuilder.Entity("Core.Models.Condominio", b =>
                {
                    ...
                    b.Navigation("ConfiguracoesMensalidade");

                    b.Navigation("Mensalidades");

                    b.Navigation("Moradores");

                    b.Navigation("NotificacoesSistema");
