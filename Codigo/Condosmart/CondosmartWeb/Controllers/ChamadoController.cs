...
namespace CondosmartWeb.Controllers
{
    ...
    public class ChamadoController : Controller
    {
        ...
        // --- MÉTODOS NOVOS DO MORADOR ---

        [HttpGet]
        public IActionResult Registrar()
        {
            return View(new RegistrarChamadoViewModel());
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Registrar(RegistrarChamadoViewModel vm)
        {
            if (!ModelState.IsValid) return View(vm);
            ...
            try
            {
                ...
                _service.RegistrarChamadoMorador(entity);
            ...
            {
                ModelState.AddModelError("", "Erro ao registrar chamado. Tente novamente.");
                return View(vm);
            }
        }
    }
